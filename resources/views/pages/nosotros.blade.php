...
@section('content')
    <section class="hero section contenido-centrado nosotros-hero flex flex-col items-center text-center">
        ...
        <p class="nosotros-hero__lead">En &iexcl;&Oacute;rale Web! somos una agencia mexicana de desarrollo web especializada en emprendedores, negocios
            locales y
            PyMEs. Creamos soluciones digitales estrat&eacute;gicas que combinan dise&ntilde;o, funcionalidad y rendimiento
            para resolver
            problemas reales y generar crecimiento.</p>
    </section>
    ...
    <section class="section nosotros-mvv">
        ...
        <div class="flex flex-col lg:flex-row gap-16 nosotros-mvv__grid">
            <div class="lg:w-2/6 nosotros-mvv__image-wrap">
                <img src="{{ asset('img/team.jpg') }}" alt="imagen nosotros"
                    class="rounded-lg object-cover w-full h-full nosotros-mvv__image" />
            </div>
            <div class="flex flex-col w-full lg:w-3/6 gap-16 mb-16 nosotros-mvv__content">
                <div class="flex flex-col gap-2 nosotros-mvv__item">
                    ...
                    <p class="nosotros-mvv__text">Empoderar a emprendedores, negocios locales y PyMEs con soluciones digitales estrat&eacute;gicas que
                        impulsen su
                ...
                <div class="flex flex-col gap-2 nosotros-mvv__item">
                    ...
                    <p class="nosotros-mvv__text">Ayudar a negocios y emprendimientos a digitalizarse de forma inteligente mediante dise&ntilde;o web
                        optimizado,
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="cars-valores grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
                <article class="card-valor">
                    ...
                    <p>No dise&ntilde;amos por est&eacute;tica. Dise&ntilde;amos para que tu p&aacute;gina web funcione, comunique valor y apoye el crecimiento de tu negocio.</p>
                </article>
                <article class="card-valor">
                    ...
                    <p>Cada decisi&oacute;n de dise&ntilde;o y contenido est&aacute; pensada para atraer, convertir y retener clientes.</p>
                </article>
                <article class="card-valor">
                    ...
                    <p>Procesos claros, tiempos definidos y comunicaci&oacute;n directa. Sabes qu&eacute; entregamos, cu&aacute;ndo y por qu&eacute; lo hacemos as&iacute;.</p>
                </article>
            </div>
        </div>
    </section>
    ...
    <section class="section text-center w-full md:w-4/6 mx-auto flex flex-col items-center gap-8 nosotros-cta">
        <h2>Tu negocio merece una presencia digital <span class="text-gradient">profesional y efectiva</span></h2>
        <p>Lleva tu presencia digital al siguiente nivel con un sitio web optimizado, estrat&eacute;gico y alineado a tus objetivos.</p>
