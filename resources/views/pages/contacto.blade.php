            ...
            <aside class="contacto__info">
                <div class="contacto__card">
                    ...
                    <div class="contacto__social">
                        <a href="#" class="contacto__social-link" aria-label="TikTok"><i class="fa-brands fa-tiktok" aria-hidden="true"></i></a>
                        <a href="#" class="contacto__social-link" aria-label="YouTube"><i class="fa-brands fa-youtube" aria-hidden="true"></i></a>
                        <a href="#" class="contacto__social-link" aria-label="Facebook"><i class="fa-brands fa-facebook-f" aria-hidden="true"></i></a>
                        <a href="#" class="contacto__social-link" aria-label="Instagram"><i class="fa-brands fa-instagram" aria-hidden="true"></i></a>
                    </div>
