...
@section('content')
    ...
    <section class="section contenido-centrado flex flex-col items-center text-center gap-6">
        <h1 class="w-full lg:w-4/6 mx-auto text-center">Explora cómo se vería <span class="text-gradient">tu negocio en internet</span> </h1>
        <p class="w-full lg:w-4/6 mx-auto text-center">Estas demos son ejemplos de cómo podríamos presentar tu negocio en línea. Cada una está diseñada para mostrar diferentes estilos y enfoques, pero todas pueden ser personalizadas para reflejar la identidad única de tu marca.</p>
    </section>
