...
@section('content')
    <div class="min-h-screen bg-[#f6f7fb] px-4 font-['Poppins']">
        <div class="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center py-12">
            ...
            <h3 class="text-3xl font-semibold text-gray-900 text-center">Crea tu contrasena</h3>
            <p class="mt-2 text-center text-2xl text-gray-500">Define una contrasena para activar tu acceso</p>
            ...
            <div class="login-card mt-8 w-full rounded-2xl bg-white p-10 shadow-lg">
                ...
                <form action="{{ route('password.setup.store') }}" method="POST" class="space-y-5" novalidate>
                    @csrf
                    ...
                    <div>
                        <label class="mb-2 block text-xl font-medium text-gray-600">Nueva contrasena</label>
                        <input type="password" name="password" required
                            class="text-xs w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-800 placeholder-gray-400 outline-none transition focus:border-[#5e1ed3] focus:ring-2 focus:ring-[#5e1ed3]/20"
                            placeholder="Minimo 8 caracteres">
                    </div>

                    <div>
                        <label class="mb-2 block text-xl font-medium text-gray-600">Confirmar contrasena</label>
