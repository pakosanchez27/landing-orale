    ...
    <div class="min-h-screen bg-[#f6f7fb] px-4 font-['Poppins']">
        <div class="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center py-12">
            <div class="mb-8 flex items-center justify-center">
                <img src="{{ asset('img/LogoNegro.png') }}" alt="Logo de Órale Web" class="h-64 w-64 object-contain" />
            </div>

            <h3 class="text-3xl font-semibold text-gray-900 text-center">Iniciar sesión</h3>
            ...
            <div class="login-card mt-8 w-full rounded-2xl bg-white p-10 shadow-lg">
                ...
                <form action="{{ route('admin.login') }}" method="POST" class="space-y-5" novalidate>
                    ...
                    <div>
                        <label class="mb-2 block text-xl font-medium text-gray-600">Correo electrónico</label>
                    ...
                    <div>
                        <label class="mb-2 block text-xl font-medium text-gray-600">Contraseña</label>
                        <div class="relative">
                ...
                <div class="mt-5 text-center">
                    <a href="#" class="text-xs text-gray-400 hover:text-[#5e1ed3]">¿Olvidaste tu contraseña?</a>
                </div>
            </div>
