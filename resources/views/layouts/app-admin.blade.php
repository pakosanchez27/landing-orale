        ...
        <aside class="admin-sidebar" id="admin-sidebar" aria-label="Sidebar">
            <div class="admin-sidebar__brand">
                <div class="admin-brand">
                    <img src="{{ asset('img/LogoBlanco.png') }}" alt="Logo de &Oacute;rale Web" class="admin-brand__logo" />
                </div>
            ...
            <nav class="admin-nav">
                ...
                <a href="#" class="admin-nav__item">
                    ...
                    <span class="admin-nav__text">Configuraci&oacute;n</span>
                </a>
                <div class="admin-nav__group">
                    <button type="button" class="admin-nav__item admin-nav__parent" id="catalogos-toggle" aria-expanded="false" aria-controls="catalogos-children">
        ...
        <div class="admin-main">
            <div class="admin-navtop">
                ...
                <button class="admin-user" type="button" id="admin-user-btn" aria-expanded="false">
                    <img src="{{ asset('img/perfil.jpg') }}" alt="Foto de usuario" />
                    <span class="admin-user__info">
                        <strong>Dwayne Tatum</strong>
                        <small>CEO Assistant</small>
                    </span>
                ...
                <div class="admin-user-menu" id="admin-user-menu" hidden>
                    <a href="#">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4zm0 2c-4.418 0-8 2.239-8 5v1h16v-1c0-2.761-3.582-5-8-5z" fill="currentColor"/></svg>
                        Mi perfil
                    </a>
                    <a href="#">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M19.14 12.936a7.487 7.487 0 0 0 .052-.936 7.487 7.487 0 0 0-.052-.936l2.036-1.58a.5.5 0 0 0 .12-.64l-1.928-3.338a.5.5 0 0 0-.6-.22l-2.4.96a7.14 7.14 0 0 0-1.62-.936l-.36-2.54a.5.5 0 0 0-.494-.42h-3.856a.5.5 0 0 0-.494.42l-.36 2.54a7.14 7.14 0 0 0-1.62.936l-2.4-.96a.5.5 0 0 0-.6.22L2.704 8.844a.5.5 0 0 0 .12.64l2.036 1.58a7.487 7.487 0 0 0-.052.936 7.487 7.487 0 0 0 .052.936l-2.036 1.58a.5.5 0 0 0-.12.64l1.928 3.338a.5.5 0 0 0 .6.22l2.4-.96a7.14 7.14 0 0 0 1.62.936l.36 2.54a.5.5 0 0 0 .494.42h3.856a.5.5 0 0 0 .494-.42l.36-2.54a7.14 7.14 0 0 0 1.62-.936l2.4.96a.5.5 0 0 0 .6-.22l1.928-3.338a.5.5 0 0 0-.12-.64zM12 15.5A3.5 3.5 0 1 1 15.5 12 3.504 3.504 0 0 1 12 15.5z" fill="currentColor"/></svg>
                        Configuraci&oacute;n
                    </a>
                    <button type="button">
                        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M10 17l1.41-1.41L8.83 13H20v-2H8.83l2.58-2.59L10 7l-5 5 5 5zm-8 4h8v-2H4V5h6V3H2z" fill="currentColor"/></svg>
