        ...
        <div class="navegacion flex items-center justify-between">
            ...
            <nav class="hidden lg:flex">
                <ul class="menu flex space-x-8 text-white">
                    ...
                    <li><a href="#" class="font-bold">Nosotros</a></li>
                    <li><a href="#" class="font-bold">Demos</a></li>
                    <li><a href="#" class="font-bold">Blog</a></li>
                    <li><a href="#" class="font-bold">FAQ'S</a></li>
                    <li><a href="#" class="font-bold">Contacto</a></li>
                </ul>
            </nav>
